...
RSpec.describe "multi_spec_samples/new", :type => :view do
  before(:each) do
    assign(:multi_spec_sample, MultiSpecSample.new(
  ...
  it "renders new multi_spec_sample form" do
    render

    assert_select "form[action=?][method=?]", multi_spec_samples_path, "post" do
